                                ...
                                <thead className="bg-gray-50">
                                    <tr>
                                        <th scope="col" className="py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-900 sm:pl-6">
                                            <div class="flex items-center cursor-pointer" onClick={() => { sortTable('branchName'); setSort(!sort) }}>ชื่อ
                                        ...
                                        <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                            <div class="flex items-center cursor-pointer" onClick={() => { sortTable('branchType.value1'); setSort(!sort) }}>ประเภท
                                                {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}

                                            </div>
                                        </th>
                                        <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                            <div class="flex items-center cursor-pointer" onClick={() => { sortTable('product.value1'); setSort(!sort) }}>ผลผลิต
                                                {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}
                                        ...
                                        <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                            ...
                                            <div class="flex items-center cursor-pointer" onClick={() => { sortTable('supervisor.firstName'); setSort(!sort) }}>ผู้ดูแล
                                                {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}

                                            </div>
                                        </th>
                                        <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                            <div class="flex items-center cursor-pointer" onClick={() => { sortTable('areaSize'); setSort(!sort) }}>
                                                ขนาดพื้นที่
                                                {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}
