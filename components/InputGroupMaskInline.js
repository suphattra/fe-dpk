...
export default function InputGroupMaskInline({
  label,
  type,
  classes,
  id,
            ...
            <div className="mt-1">
              <div
                className={classNames(
                  unit ? "relative mt-1 rounded-md shadow-sm" : ""
                )}
              >
                <input
                  type={type}
                ...
                {unit && (
                  <div class="absolute inset-y-2 right-0 flex items-center">
                    <label
                      for="currency"
                      className="h-full border-l border-gray-300 bg-transparent py-1 pl-4 pr-4 text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-xs"
                    >
                      {unit}
                    </label>
                  </div>
              ...
              >
                <MaskedInput
                  ...
                  className={classNames(
                    ...
                    classes,
                    "block w-full rounded-md shadow-sm sm:text-sm disabled:text-gray-800 disabled:bg-gray-50 disabled:text-gray-500"
                  )}
                  placeholder=""
                  guide={false}
...
InputGroupMaskInline.defaultProps = {
  disabled: false,
  type: "text",
  placeholder: "",
  require: false,
