...
import { InputGroup, InputGroupDate, InputRadioGroup, InputSelectGroup, InputGroupMask, InputGroupCurrency } from "./../../components";
...
import { PaymentService } from "./../../pages/api/payment.service";
import { CustomerService } from "./../../pages/api/customer.service";
import { MapService } from "./../../pages/api/map.service";
...
import { PackageService } from "./../../pages/api/package.service";
import MaskedInput from "react-text-mask";
import ModalPrintTax from "../report/ModalPrintTax";
const breadcrumbs = [{ index: 1, href: '/job', name: 'job' }, { index: 2, href: '/job/detail/create-job', name: 'detail' }]

export default function ViewJobDashboard({ mode_, id_, callBackToDashboard }) {
    ...
    const [modePayment, setModePayment] = useState(mode_)
                                ...
                                <div className="mx-auto w-full max-w-full pt-6">
                                    ...
                                    <div className={openTab === 0 ? "block" : "hidden"}>
                                        ...
                                        <div className="tab-content" id="tabs-tabContent">
                                            ...
                                            <section className="w-full mt-4 pb-16 pt-0 overflow-y-auto h-[calc(100vh-300px)] sm:px-6 lg:px-8" id="tabs-home" role="tabpanel" aria-labelledby="tabs-home-tab">
                                                <form className="space-y-4" onSubmit={handleSubmit(submitOrderJobEntry)} id='inputForm'>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mb-4 mt-6">
                                        ...
                                        <footer className="flex items-center justify-end sm:px-6 lg:px-8 sm:py-4 lg:py-4 bg-gray-100">
                                            ...
                                            <div className={`${showTooltip ? "visible" : "invisible"} fixed bg-white bottom-12 w-100 `}>
