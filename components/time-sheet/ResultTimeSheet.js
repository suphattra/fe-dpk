                                    ...
                                    <thead className="bg-gray-50">
                                        <tr>
                                            <th scope="col" className="py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-900 sm:pl-6">
                                                <div class="flex items-center cursor-pointer" onClick={() => { sortTable('employee.firstName'); setSort(!sort) }}>พนักงาน
                                            ...
                                            <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                                <div class="flex items-center cursor-pointer" onClick={() => { sortTable('mainBranch.branchName'); setSort(!sort) }}>แปลงใหญ่
                                                    {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}

                                                </div>
                                            </th>
                                            <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                                <div class="flex items-center cursor-pointer" onClick={() => { sortTable('subBranch.branchName'); setSort(!sort) }}>แปลงย่อย
                                                    {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}
                                            ...
                                            <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                                ...
                                                <div class="flex items-center cursor-pointer" onClick={() => { sortTable('task.value1'); setSort(!sort) }}>งาน
                                                    {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}

                                                </div>
                                            </th>
                                            <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                                <div class="flex items-center cursor-pointer" onClick={() => { sortTable('taskAmount'); setSort(!sort) }}>
                                                    จำนวน
                                                    {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}
                                            ...
                                            <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                                <div class="flex items-center cursor-pointer" onClick={() => { sortTable('taskPaymentRate'); setSort(!sort) }}>
                                                    ค่าแรง
                                                    {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}
                                            ...
                                            <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                                <div class="flex items-center cursor-pointer" onClick={() => { sortTable('otTotal'); setSort(!sort) }}>
                                                    OT
                                                    {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}
                                                </div>
                                            </th>
                                            ...
                                            <th scope="col" className="px-3 py-3.5 text-sm font-semibold text-gray-900">
                                                ...
                                                <div class="flex items-center cursor-pointer" onClick={() => { sortTable('operationStatus.value1'); setSort(!sort) }}>
                                                    สถานะงาน
                                                    {sort ? <BarsArrowUpIcon className="w-3 h-3 ml-1.5 mt-1" /> : <BarsArrowDownIcon className="w-3 h-3 ml-1.5 mt-1" />}
                                        ...
                                        {operationsList && operationsList.length > 0 && operationsList.map((job) => (
                                            <>
                                                <tr >
                                                    ...
                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{job.mainBranch.branchName}</td>
                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{job.subBranch.branchName}</td>
                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{job.task.value1}</td>
                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{job.taskAmount}</td>
                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{job.taskPaymentRate}</td>
